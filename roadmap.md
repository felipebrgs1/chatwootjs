...
| -: | ------ | ------------------ | :----: | ---------- | --- |
| 01 | Dashboard | Shell/UX 1:1: sidebar, layout, temas, command bar, rotas base | 🟡 | — | [`roadmap/01 - dashboard.md`](roadmap/01%20-%20dashboard.md) |
| 02 | Conversas & Mensagens | Coração do produto: thread, composer, filtros, bulk, drafts, realtime | 🟡 | 01 | [`roadmap/02 - conversas-e-mensagens.md`](roadmap/02%20-%20conversas-e-mensagens.md) |
| 03 | Contatos & Empresas | CRUD, merge, import/export CSV, atributos, segmentos | 🟡 | 02 | [`roadmap/03 - contatos-e-empresas.md`](roadmap/03%20-%20contatos-e-empresas.md) |
| 04 | Inboxes & Canais | Inboxes, membros, working hours e os 11 canais (in/out/webhook) | 🟡 | 02 | [`roadmap/04 - inboxes-e-canais.md`](roadmap/04%20-%20inboxes-e-canais.md) |
| 05 | Atribuição, Times & Agentes | Times, agentes, assignment policies e auto-atribuição | 🟡 | 02, 04 | [`roadmap/05 - atribuicao-times-agentes.md`](roadmap/05%20-%20atribuicao-times-agentes.md) |
| 06 | Automação, Macros, Canned & Webhooks | Regras, macros, respostas prontas e webhooks de saída | 🟡 | 02 | [`roadmap/06 - automacao-macros-canned-webhooks.md`](roadmap/06%20-%20automacao-macros-canned-webhooks.md) |
| 07 | Relatórios & CSAT | API v2, live/summary reports, CSAT e exportação | 🟡 | 02 | [`roadmap/07 - relatorios-e-csat.md`](roadmap/07%20-%20relatorios-e-csat.md) |
| 08 | Help Center | Portais, categorias, artigos, API pública e portal | 🟡 | 01 | [`roadmap/08 - help-center.md`](roadmap/08%20-%20help-center.md) |
| 09 | Widget & API Pública | Widget embeddável, API pública de inbox e CSAT público | 🟡 | 02, 04 | [`roadmap/09 - widget-e-api-publica.md`](roadmap/09%20-%20widget-e-api-publica.md) |
| 10 | Integrações & Apps | Dashboard apps, Slack/Linear/Notion/Shopify/Dyte, OAuth | ❌ | 01, 09 | [`roadmap/10 - integracoes-e-apps.md`](roadmap/10%20-%20integracoes-e-apps.md) |
| 11 | Notificações, Busca & Comandos | Sino, preferências, subscriptions, busca global, ⌘K, views | 🟡 | 02 | [`roadmap/11 - notificacoes-busca-comandos.md`](roadmap/11%20-%20notificacoes-busca-comandos.md) |
| 12 | Auth, Conta & Segurança | Login/invite/reset/confirmação, perfil, MFA, sessões, conta | 🟡 | — | [`roadmap/12 - auth-conta-seguranca.md`](roadmap/12%20-%20auth-conta-seguranca.md) |
| 13 | Superadmin, Platform & Onboarding | Console global, Platform API e onboarding da conta | 🟡 | 12 | [`roadmap/13 - superadmin-platform-onboarding.md`](roadmap/13%20-%20superadmin-platform-onboarding.md) |
| 14 | E-mail, Jobs & Realtime (infra) | Mailers transacionais, filas, ActionCable multi-réplica, storage | 🟡 | transversal | [`roadmap/14 - email-jobs-realtime-infra.md`](roadmap/14%20-%20email-jobs-realtime-infra.md) |
| 15 | Captain & IA | Tasks OSS de IA com flag/provider; enterprise fora | 🟡 | 02, 14 | [`roadmap/15 - captain-e-ia.md`](roadmap/15%20-%20captain-e-ia.md) |

Legenda de status: `❌` ausente/estrutural · `🟡` parcial · `✅` 100% (aceite do doc cumprido).
